                ...
                <div className="row ">
                    ...
                    <div className="col-md-4">
                        <div className="col-md-12">
                            ...
                            <span style={{ color: 'darkorange', fontWeight: 'bold' }}> <i class="fas fa-utensils"></i> Authentic Fiesta</span>

                            <br />
                            <small style={{ color: 'darkorange' }}>Try, Eat & Enjoy!</small>
                            <br />
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3">
                                ...
                                <ul>
                                    ...
                                    <br />
                                    <Card.Link href="#">Recipes</Card.Link>
                                    <br />
